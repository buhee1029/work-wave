...
public enum ErrorType {
    ...
    W004("W004", "작업이 있는 워크플로우는 삭제할 수 없습니다.", WorkflowHasWorksException.class, HttpStatus.CONFLICT),
    ...
    W007("W007", "존재하지 않는 작업 입니다.", NotFoundWorkException.class, HttpStatus.NOT_FOUND),
